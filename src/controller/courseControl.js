const { insertData, fetchAllCourse, fetchCreatorsCourse, insertExamData, fetchQuizOfCourseId,
    fetchAssignmentOfCourseId, fetchSingleCourse, deleteOne } = require('../model/courses');
